...
function bars(){
    if(document.getElementById('submainnav').style.display == 'block'){
        document.getElementById('submainnav').style.display = 'none';
        document.getElementById('icon').className = 'fas fa-stream';
    }
    else{
        document.getElementById('submainnav').style.display = 'block';
...
function show5(){
  if(document.getElementById('submenu9').style.display == 'block' && document.getElementById('submenu10').style.display == 'block'){
    document.getElementById('submenu9').style.display = 'none';
    document.getElementById('submenu10').style.display = 'none';
}
    else{
